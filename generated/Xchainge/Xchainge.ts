...
export class Xchainge__getListingResultValue0Struct extends ethereum.Tuple {
  get price(): BigInt {
...
export class Xchainge extends ethereum.SmartContract {
  static bind(address: Address): Xchainge {
    return new Xchainge("Xchainge", address);
  }

  getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): Xchainge__getListingResultValue0Struct {
    ...
    return changetype<Xchainge__getListingResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): ethereum.CallResult<Xchainge__getListingResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<Xchainge__getListingResultValue0Struct>(value[0].toTuple())
    );
  }
